...
Often, these template files can grow quite large.
When they do, they should be broken down into multiple files under `templates/_xyz.tpl` to facilitate clarity and maintainability.
